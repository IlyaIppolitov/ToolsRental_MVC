...
public class BaseInitController {
    ...
    private void itemsInit(){
        itemService.save(Item.builder()
            ...
            .model("GWX 10-125")
            .price(500.)
            .img("/img/shop/Bosch/GWX 10-125.png")
        ...
        itemService.save(Item.builder()
            ...
            .model("GWX 14-125")
            .price(700.)
            .img("/img/shop/Bosch/GWX 14-125.png")
            .brand(brandService.findByName("Bosch").get())
            .category(categoryService.findByName("Болгарка").get())
            .position(StockPosition.builder()
                .amount(random.nextInt(900) + 100)
        ...
        itemService.save(Item.builder()
            ...
            .model("PWS 650-125")
            .price(300.)
            .img("/img/shop/Bosch/PWS 650-125.png")
            .brand(brandService.findByName("Bosch").get())
            .category(categoryService.findByName("Болгарка").get())
            .position(StockPosition.builder()
                .amount(random.nextInt(900) + 100)
        ...
        itemService.save(Item.builder()
            ...
            .model("9558HN")
            .price(400.)
            .img("/img/shop/Makita/9558HN.png")
        ...
        itemService.save(Item.builder()
            ...
            .model("GA5030RX9")
            .price(450.)
            .img("/img/shop/Makita/GA5030RX9.png")
            .brand(brandService.findByName("Makita").get())
            .category(categoryService.findByName("Болгарка").get())
            .position(StockPosition.builder()
                .amount(random.nextInt(900) + 100)
        ...
        itemService.save(Item.builder()
            ...
            .model("9565CVR")
            .price(1000.)
            .img("/img/shop/Makita/9565CVR.png")
            .brand(brandService.findByName("Makita").get())
            .category(categoryService.findByName("Болгарка").get())
            .position(StockPosition.builder()
                .amount(random.nextInt(900) + 100)
        ...
        itemService.save(Item.builder()
            ...
            .model("SG150")
            .price(400.)
            .img("/img/shop/Makita/SG150.png")
            .brand(brandService.findByName("Makita").get())
            .category(categoryService.findByName("Штроборез").get())
            .position(StockPosition.builder()
                .amount(random.nextInt(900) + 100)
                .build())
            .build());
        itemService.save(Item.builder()
            ...
            .model("GNF35CA")
            .price(1600.)
            .img("/img/shop/Bosch/GNF35CA.png")
            .brand(brandService.findByName("Bosch").get())
            .category(categoryService.findByName("Штроборез").get())
            .position(StockPosition.builder()
                .amount(random.nextInt(900) + 100)
